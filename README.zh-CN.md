...
> 小陈的 Claude Code 插件集：17 个面向视频制作、内容发布和知识管理的个人自动化技能。
...
| [cyxj-hook](./plugins/cyxj-hook/) | 知识视频开头/钩子优化（3 分钟+ 冲抖音精选）：诊断开头问题并生成方案，结果先行 / 认知落差 / 身份反差 / 结构预告四型 | `/cyxj-hook`、`优化我的视频开头`、`帮我看开头`、`开头钩子` | 无（纯指令型技能） |
| [cyxj-content](./plugins/cyxj-content/) | 知识视频内容六维诊断（文字洁癖 / 封面标题 / 完播价值密度 / 认知落差 / 可复用资产+落点 / AI 辅助） | `/内容诊断`、`这个内容怎么做`、`帮我看看这条稿` | 无（纯指令型技能） |
...
**怎么安装？**
在 Claude Code 里运行 `/plugin marketplace add chenyuxiaojin/xiaochen-skills`，17 个插件全部注册。
