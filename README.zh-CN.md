...
> 小陈的 Claude Code 插件集：16 个插件（17 个技能），面向视频制作、内容发布和知识管理。
...
| 技能数量 | 17 个技能 / 16 个插件 | 随示例变化 | 多仓库分散 |
...
**怎么安装？**
在 Claude Code 里运行 `/plugin marketplace add chenyuxiaojin/xiaochen-skills`，16 个插件（17 个技能）全部注册。
